            ...
            <div className="max-w-[1240px] mx-auto px-4p">
                ...
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="bg-[#131d31] border border-cyan-400/10 rounded-2xl p-8 hover:border-cyan-400 hover:-translate-y-2 duration-300">
                        ...
                        <p className="text-gray-400">Building complete web application from responsive user interfaces to scalable backend and database systems. </p>
                    </div>
                    {/* AI Engineer */}
                    <div className="bg-[#131d31] border border-cyan-400/10 rounded-2xl p-8 hover:border-cyan-400 hover:-translate-y-2 duration-300">
                        <FaRobot className="text-5xl text-[#1cb9f1] mb-6"/>
                        <h3 className="font-serif text-2xl font-bold mb-4">AI Engineer</h3>
                        <p className="text-gray-400">Developing intelligent systems using Machine Learning, Computer Vision and Deep Learning technologies. </p>
                    </div>
                    {/* Software Engineer */}
                    <div className="bg-[#131d31] border border-cyan-400/10 rounded-2xl p-8 hover:border-cyan-400 hover:-translate-y-2 duration-300">
                        <FaCode className="text-5xl text-[#1cb9f1] mb-6"/>
                        <h3 className="font-serif text-2xl font-bold mb-4">Software Engineer. </h3>
                        <p className="text-gray-400">Designing reliable software solutions with clear architecture, maintainable code and modern engineering practices. </p>
                    </div>
                    {/* AI automation */}
                    <div className="bg-[#131d31] border border-cyan-400/10 rounded-2xl p-8 hover:border-cyan-400 hover:-translate-y-2 duration-300">
